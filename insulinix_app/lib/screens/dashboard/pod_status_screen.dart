...
class _PodStatusScreenState extends State<PodStatusScreen> {
  ...
  void initState() {
    ...
    _bluetoothController = Provider.of<BluetoothController>(
      context,
      listen: false,
    );
  ...
  void _subscribeToData() {
    ...
    _dataSubscription = _bluetoothController?.receivedDataStream.listen(
      (data) {
    ...
    return Selector<BluetoothController, BleConnectionState>(
      ...
      builder: (context, connectionState, child) {
        ...
        if (connectionState != _previousConnectionState) {
          print(
            "Connection state changed from $_previousConnectionState to $connectionState",
          );
